## train the model outside Streamlit
...
## train the model inside Streamlit
import pandas as pd 
import streamlit as st 
...
st.title('Penguin Classifer: A Machine Learning App')
st.write("This app uses 6 inputs to predict the species of penguin using"
         " a model built on the Palmer's Penguin's dataset"
         " Use the form below to get started!")
...
if not penguin_file:
    ...
    st.write("We trained a Random Forest model on thest data, it has a score of {}! \
...
st.write("Below are the histograms for each continous variable \
